...
public class VarInt {
    ...
    public static void main(String[] args) {
        int testInt = 200;
        int varIntSize = varIntSize(testInt);
        System.out.println(varIntSize);
        byte[] varIntArray = new byte[varIntSize + 1];
        int newOffset = putVarInt(testInt, varIntArray, 0);
        System.out.println(newOffset);
        System.out.println((int) varIntArray[0]);
        System.out.println((int) varIntArray[1]);
        int[] result = new int[1];
        getVarInt(varIntArray, 0, result);
        System.out.println(result[0]);
        System.out.println(getVarInt(ByteBuffer.wrap(varIntArray)));
    }
}
